    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = ProductsAdapter(
            listOf(
                ...
                Product("Blue Berry", "https://loremflickr.com/320/240?lock=4", 2.0F),
                Product("Dark Chocolate", "https://cdn.pixabay.com/photo/2017/11/22/00/18/donuts-2969490_1280.jpg", 1.25f ),
